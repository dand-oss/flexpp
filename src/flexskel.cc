...
#endif
    {
    YY_@_CHAR *dest = YY_@_CURRENT_BUFFER->yy_ch_buf;
    YY_@_CHAR *source = yy___text - 1; /* copy prev. char, too */
...
#ifndef YY_USE_CLASS
static void yyunput( YY_@_CHAR c, YY_@_CHAR *yy_bp )
#else
